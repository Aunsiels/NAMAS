...
local nnlm = require('summary.nnlm_rec_nocuda')
local data = require('summary.data_rnn_nocuda')
...
local function main()
   ...
   local tdata1 = data.load_title(opt.titleDir, "1")
   local article_data1 = data.load_article(opt.articleDir, "1")
   ...
   mlp:train(train_data, train_data2, valid)
end
